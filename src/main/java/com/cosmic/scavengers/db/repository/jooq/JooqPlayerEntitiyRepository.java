...
@Repository
public class JooqPlayerEntitiyRepository {

	private final DSLContext dsl;

	public JooqPlayerEntitiyRepository(DSLContext dsl) {
		this.dsl = dsl;
	}
	...
	public List<PlayerEntities> getAllByPlayerId(Long playerId) {
		return dsl.selectFrom(PLAYER_ENTITIES).where(PLAYER_ENTITIES.PLAYER_ID.eq(playerId))
