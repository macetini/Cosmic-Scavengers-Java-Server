...
class MovementSystemTest {
	...
	void test_CalculateDistanceDelta_3D() {
		final Position position = new Position(
				DecimalUtil.fromScaled(0L), 
				DecimalUtil.fromScaled(0L),
				DecimalUtil.fromScaled(0L));

		final Movement movement = new Movement(
				DecimalUtil.fromScaled(10L),	// Target X
				DecimalUtil.fromScaled(5L),	// Target Y
				DecimalUtil.fromScaled(2L), 	// Target Z
				DecimalUtil.fromScaled(1L));	// Speed
	...
	void test_CalculateDistanceSquaredUnscaled_3DPythagoras() {
		final DistanceDelta delta = new DistanceDelta(
				DecimalUtil.fromScaled(3L), 
				DecimalUtil.fromScaled(4L),
				DecimalUtil.fromScaled(12L));
	...
	void test_Whole_3DMovement_SingleTick() {
		...
		final Movement move = new Movement(
				DecimalUtil.fromScaled(10L), 
				DecimalUtil.fromScaled(0L),
				DecimalUtil.fromScaled(0L), 
				DecimalUtil.fromScaled(1L));
	...
	void test_CalculateDistanceDelta_PositiveVector() {
		...
		final Decimal<Scale4f> startX = DecimalUtil.fromScaled(0L);
		final Decimal<Scale4f> startY = DecimalUtil.fromScaled(0L);
		final Decimal<Scale4f> startZ = DecimalUtil.fromScaled(0L);

		final Position position = new Position(startX, startY, startZ);

		final Decimal<Scale4f> targetX = DecimalUtil.fromScaled(10L);
		final Decimal<Scale4f> targetY = DecimalUtil.fromScaled(5L);
		final Decimal<Scale4f> targetZ = DecimalUtil.fromScaled(2L);

		final Decimal<Scale4f> speed = DecimalUtil.fromScaled(1L);
	...
	void test_CalculateNormalizedDirection_3D() {
		...
		final Decimal<Scale4f> deltaX = DecimalUtil.fromScaled(3L);
		final Decimal<Scale4f> deltaY = DecimalUtil.fromScaled(4L);
		final Decimal<Scale4f> deltaZ = DecimalUtil.fromScaled(12L);
